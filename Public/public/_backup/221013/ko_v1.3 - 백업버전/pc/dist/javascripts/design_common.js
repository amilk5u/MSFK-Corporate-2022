...
function main() {
	...
	function index() {
		...
		function socialMotion2() {
			...
			// 가로 스크롤 실행
			sec2ContainerTimeLine.to('#social .content2 .horizontal_wrap', { x: _horizontalW, duration: 30, delay: 1.5, ease: Power0.easeNone, })
		...
		function corporationMotion1() {
			const sec1ContainerTimeLine = gsap.timeline();
			/* 동행기업 참여방법 ----------------------------------------------------------- */
			sec1ContainerTimeLine.to('#corporation .content1 .txt_wrap', { y: -300, duration: 2 })
			// 참여방법 1
			...
			sec1ContainerTimeLine.to('#corporation', { opacity: 1, duration: 2 })
			return sec1ContainerTimeLine;
		}
