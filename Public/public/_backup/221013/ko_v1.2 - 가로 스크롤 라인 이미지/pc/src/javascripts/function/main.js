function main() {
	...
	function index() {
		...
		function introMotion1() {
			...
			sec1ContainerTimeLine.to('#intro .content2 .round_wrap .round_elm6 img', { bottom: 0, duration: .3, delay: -.15 })
			sec1ContainerTimeLine.to('#intro .content2 .round_wrap .round_elm4 img', { bottom: 0, duration: .3, delay: -.15 })
			sec1ContainerTimeLine.to('#intro .content2 .round_wrap .round_elm1 img', { bottom: 0, duration: .3, delay: -.15 })
			sec1ContainerTimeLine.to('#intro .content2 .round_wrap .round_elm5 img', { bottom: 0, duration: .3, delay: -.15 })
			sec1ContainerTimeLine.to('#intro .content2 .round_wrap .round_elm3 img', { bottom: 0, duration: .3, delay: -.15 })
			sec1ContainerTimeLine.to('#intro .content2 .txt_cont3 p', { opacity: 0, yPercent: 0, duration: .5, delay: 1 })
			// 작은 데코 사라지기 *****
			sec1ContainerTimeLine.to('#intro .content2 .deco_wrap span', { opacity: 0, duration: .0001})
			// 텍스트 4
			sec1ContainerTimeLine.to('#intro .content2 .txt_cont4 p', { opacity: 1, yPercent: -20, duration: .5 })
			sec1ContainerTimeLine.to('#intro .content2', { display: 'none', opacity: 0, duration: .5, delay: 2 })
		...
		function introMotion2() {
			...
			// video
			sec2ContainerTimeLine.to('#intro .content3 .earth_contain .video_wrap video', { opacity: 1, duration: .6 })
			// deco 순차적으로 나타나기
			// 원 데코
			...
			sec2ContainerTimeLine.to('#intro .content3 .earth_contain .video_wrap video', { opacity: 0, duration: .5 })
			...
			// 총 수입
			sec2ContainerTimeLine.to('#intro .content3 .graph_contain .income_tit', { display: 'block', opacity: 1, yPercent: -20, duration: .5, delay:.3 })
			// 19억 3500만 유로
			...
			// 텍스트 2
			sec2ContainerTimeLine.to('#intro .content4 .txt_wrap .elm2', { opacity: 1, duration: .8, delay:1})
